      ...
      <div className="signup-form-section">
        ...
        <div className="form-content">
          <div className="form-intro">
            <span className="badge">START FOR FREE</span>
          ...
          <form className="signup-form">
            <div className="form-group">
              ...
              <input className="form-input" placeholder="Enter your full name" type="text" />
            </div>

            <div className="form-group">
              <label className="form-label">Email</label>
              <input className="form-input" placeholder="name@company.com" type="email" />
            </div>
